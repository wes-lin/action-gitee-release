This library is inspired by [action-gh-release](https://github.com/softprops/action-gh-release).
...
<p align="center">
   A GitHub Action for creating Gitee Releases on Linux, Windows, and macOS virtual environments
</p>
...
<div align="center">
  <a href="https://github.com/wes-lin/action-gitee-release/actions">
		<img src="https://github.com/wes-lin/action-gitee-release/workflows/build/badge.svg"/>
	</a>
</div>
...
jobs:
  build:
    ...
    steps:
      ...
      - name: Release
        uses: wes-lin/action-gitee-release@main
...
Below is an example of uploading more than one asset with a Gitee release
